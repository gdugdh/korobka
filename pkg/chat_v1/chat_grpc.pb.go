...
type ChatV1Client interface {
	ConnectUser(ctx context.Context, in *ConnectUserRequest, opts ...grpc.CallOption) (ChatV1_ConnectUserClient, error)
...
func (c *chatV1Client) ConnectUser(ctx context.Context, in *ConnectUserRequest, opts ...grpc.CallOption) (ChatV1_ConnectUserClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatV1_ServiceDesc.Streams[0], "/chat_v1.ChatV1/ConnectUser", opts...)
	if err != nil {
		return nil, err
	}
	x := &chatV1ConnectUserClient{stream}
...
type ChatV1_ConnectUserClient interface {
	Recv() (*Message, error)
	grpc.ClientStream
}

type chatV1ConnectUserClient struct {
	grpc.ClientStream
}

func (x *chatV1ConnectUserClient) Recv() (*Message, error) {
	m := new(Message)
...
func (c *chatV1Client) GetChatMessages(ctx context.Context, in *GetChatMessagesRequest, opts ...grpc.CallOption) (*GetChatMessagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat_v1.ChatV1/GetChatMessages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatV1Client) GetChats(ctx context.Context, in *GetChatsRequest, opts ...grpc.CallOption) (*GetChatsResponse, error) {
...
type ChatV1Server interface {
	ConnectUser(*ConnectUserRequest, ChatV1_ConnectUserServer) error
...
func (UnimplementedChatV1Server) ConnectUser(*ConnectUserRequest, ChatV1_ConnectUserServer) error {
...
func (UnimplementedChatV1Server) GetChats(context.Context, *GetChatsRequest) (*GetChatsResponse, error) {
...
func _ChatV1_ConnectUser_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ConnectUserRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ChatV1Server).ConnectUser(m, &chatV1ConnectUserServer{stream})
}

type ChatV1_ConnectUserServer interface {
	Send(*Message) error
	grpc.ServerStream
}

type chatV1ConnectUserServer struct {
	grpc.ServerStream
}

func (x *chatV1ConnectUserServer) Send(m *Message) error {
...
func _ChatV1_GetChatMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat_v1.ChatV1/GetChatMessages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatV1_GetChats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).GetChats(ctx, req.(*GetChatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _ChatV1_ConnectUser_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "chat.proto",
